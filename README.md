...
#> 1 “파업 동의하지~ 학교 비정규직인 급~ 미디어오~ 2019-07-06 13:46:41 NA                  김예리 ~

np_news("http://www.mediatoday.co.kr/news/articleView.html?idxno=201015") %>% 
  glimpse()
#> Observations: 1
#> Variables: 6
#> $ title        <chr> "“파업 동의하지만 아이들 우선” 부산일보 왜곡보도"
#> $ body         <chr> "학교 비정규직인 급식조리 노동자들이 이번 공공부문 비정규직 총파업에 학생들을 위해 불참...
#> $ from         <chr> "미디어오늘"
#> $ published_at <dttm> 2019-07-06 13:46:41
#> $ edited_at    <dttm> NA
#> $ by           <chr> "김예리 기자"
```
...
## 네이버 뉴스 스탠드 주요 언론사
    ...
    #> $ from         <chr> "일간스포츠"
    #> $ published_at <dttm> 2019-07-07 10:20:14
    #> $ edited_at    <dttm> NA
    #> $ by           <chr> NA
